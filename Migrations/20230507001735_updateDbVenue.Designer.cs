...
namespace TajmautMK.API.Migrations
{
    ...
    [Migration("20230507001735_updateDbVenue")]
    partial class updateDbVenue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.CategoryEvent", b =>
                {
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.Comment", b =>
                {
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.Event", b =>
                {
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.OnlineReservation", b =>
                {
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.Venue", b =>
                {
                    b.Property<int>("VenueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.Comment", b =>
                {
                    b.HasOne("TajmautMK.Common.Models.EntityClasses.User", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TajmautMK.Common.Models.EntityClasses.Venue", "Venue")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.Event", b =>
                {
                    b.HasOne("TajmautMK.Common.Models.EntityClasses.CategoryEvent", "CategoryEvent")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("TajmautMK.Common.Models.EntityClasses.OnlineReservation", b =>
                {
                    b.HasOne("TajmautMK.Common.Models.EntityClasses.Event", "Event")
